...
> ⚠️ **Compatibilité** : SwiGi est exclusivement conçu pour les appareils **Logitech Gen S** (MX Keys S, MX Keys Mini, MX Master 3S, MX Master 4, MX Vertical, etc.) utilisant le protocole HID++ 2.0 avec notification CHANGE_HOST. Les anciens modèles Logitech ne sont pas supportés.
...
Conçu pour les appareils Logitech **Gen S** (HID++ 2.0, notification CHANGE_HOST firmware). Les anciens modèles ne sont pas supportés.
...
- Logitech **Gen S** keyboard + mouse with Easy-Switch and Bluetooth (MX Keys S, MX Keys Mini, MX Master 3S, MX Master 4, MX Vertical…)
- **Older Logitech models not supported.** SwiGi relies on Gen S firmware CHANGE_HOST notifications.
...
Designed for **Gen S** Logitech devices (HID++ 2.0, CHANGE_HOST firmware notification). Older models are not supported.
